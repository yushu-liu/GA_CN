...
class Topo1(Topo):
	...
	hconfig = {'cpu': cpu}
        lconfigEth = {'bw': 10, 'delay': '1ms', 'loss': 0}
        lconfigWifi = {'bw': 2, 'delay': '5ms', 'loss': 3}
        lconfig3G = {'bw': 2, 'delay': '75ms', 'loss': 2}
	...
	sender = self.addHost('sender', **hconfig)
        ...
        # Wire sender
        self.addLink(sender, s1, port2=uplink, **lconfigEth)
        self.addLink(sender, s2, port2=uplink, **lconfigEth)
        self.addLink(sender, s3, port2=uplink, **lconfigEth)

        # Wire receiver
        self.addLink(receiver, s1, port2=downlink, **lconfigEth)
        self.addLink(receiver, s2, port2=downlink, **lconfigWifi)
        self.addLink(receiver, s3, port2=downlink, **lconfig3G)
